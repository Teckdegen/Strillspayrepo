      ...
      <div className="w-full max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center mb-8">
            <Zap className="w-16 h-16 text-primary mr-4" />
            <h1 className="text-6xl md:text-7xl font-extrabold text-foreground">
              Strills
            </h1>
          </div>
          
          <p className="text-2xl md:text-3xl text-foreground font-medium">
            Pay with <span className="text-primary font-bold">USDC</span> on{' '}
            <span className="text-secondary font-bold">Sonic</span>
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {services.map((service) => {
            ...
            return (
              ...
              >
                <div className="bg-gradient-primary p-6 rounded-xl mb-4 shadow-glow-primary">
                  <IconComponent className="w-12 h-12 text-primary-foreground mx-auto" />
                </div>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="space-y-2">
              <div className="w-12 h-12 bg-gradient-primary rounded-full flex items-center justify-center mx-auto shadow-glow-primary">
            ...
            <div className="space-y-2">
              ...
              <h3 className="text-lg font-bold text-foreground">Instant Payments</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="space-y-2">
              ...
              <h3 className="text-lg font-bold text-foreground">Low Fees</h3>
              <p className="text-muted-foreground text-sm">
